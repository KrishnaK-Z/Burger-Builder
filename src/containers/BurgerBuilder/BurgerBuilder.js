...
const BurgerBuilder =(props) => {
    ...
    let purchaseCancelHandler = () => {
        setModalState(currentState => {
            ...
            newState.purchasing = !currentState.purchasing;
            return newState;
        })
    }
    ...
    return (
        <Auxiliary>
            <div className="custom-burger-container">
                    ...
                    <div className="flex-wrapper">
                        <div className="total-price">
                            ...
                            <div className="order-btn-wrapper">
                                <button className="order-btn flex-center-item" onClick={purchaseHandler}>
                ...
                <div className="burger-controller-wrapper hide-scroll">
                    <IngredientControls
